  ...
  <div class="login">
    <div class="login-box">
      <van-nav-bar @click-left="goHome" :border="false">
        ...
        <template #left>
          <div class="close-box" ><van-icon color="#323233" size="28" name="cross" /></div>
        </template>
      </van-nav-bar>

      <div class="login-form">
        <div class="title">亲,　欢迎登陆</div>
        <div class="register">没有账号？<span @click="showPopup">立即注册</span></div>
        <div class="login-form-box">
          <van-form>
            <van-field left-icon="phone-o" placeholder="请输入手机号" v-model="userLoginInfo.phone" />
            <van-field
